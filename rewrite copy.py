...
def scoreboard(textx,texty,gameOverMessage):
    tex = font.render("score:" + str(gameOverMessage),True,(255,255,255))
...
while game_over is not True:
    ...
    if score > 20:
        didcollisionhappen2 = collision(ecoordsx*0.6 + 50,coordsx,ecoordsy*0.69 - 70,n_coordsy)
    if score > 35:
    ...
    eecoordsx = ecoordsx + enemyxchange
    if eecoordsx < 0:
        enemxchange = -5
        eecoordsy = eecoordsy + 50
    if eecoordsx > 625:
        enemxchange = -5
        eecoordsy = eecoordsy + 50
    ...
    if score >= 20:
        enemy(enem,eecoordsx*0.6 + 50,eecoordsy*0.69 - 70)
    if score >= 35:
